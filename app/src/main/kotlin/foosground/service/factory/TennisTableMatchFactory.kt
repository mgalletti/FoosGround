...
/**
 * This class creates Tennis table matches. It currently looks pretty similar to 'FoosBallMatchFactory'
 * although it might have some logic specifically for tennis table matches.
 */
class TennisTableMatchFactory(
    val owner: Player
): MatchFactory {
